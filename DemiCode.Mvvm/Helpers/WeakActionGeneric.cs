...
namespace DemiCode.Mvvm.Helpers
{
    ...
    [Obsolete("Will be internalized in a future version")]
    public class WeakAction<T> : IExecuteWithObject, IWeakAction
    {
        ...
        public MulticastDelegate TheAction { get { return _action; } }
