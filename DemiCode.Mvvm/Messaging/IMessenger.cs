...
namespace DemiCode.Mvvm.Messaging
{
    ...
    public interface IMessenger
    {
        ...
        void Register<TMessage>(object recipient, Action<TMessage> action, Predicate<TMessage> filter);
        ...
        ///     of type TMessage is sent.</param>
        /// <param name="filter">A predicate that will be evaluated before message is delivered to the recipient</param>
        void Register<TMessage>(object recipient, object token, Action<TMessage> action, Predicate<TMessage> filter);
        ...
        ///     of type TMessage is sent.</param>
        /// <param name="filter">A predicate that will be evaluated before message is delivered to the recipient</param>
        void Register<TMessage>(object recipient, object token, bool receiveDerivedMessagesToo, Action<TMessage> action, Predicate<TMessage> filter);
        ...
        ///     of type TMessage is sent.</param>
        /// <param name="filter">A predicate that will be evaluated before message is delivered to the recipient</param>
        void Register<TMessage>(object recipient, bool receiveDerivedMessagesToo, Action<TMessage> action, Predicate<TMessage> filter);
